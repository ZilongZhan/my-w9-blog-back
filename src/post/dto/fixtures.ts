...
import { PostDataDto, PostDocumentDto } from "./types.js";
...
export const macAndCheeseDocumentDto: PostDocumentDto = {
...
export const pulledPorkDocumentDto: PostDocumentDto = {
  _id: new Types.ObjectId().toString(),
  publishDate: "2025-04-14T11:30:00.000Z",
  title: "Slow Cooker BBQ Pulled Pork",
  imageUrl: "https://example.com/images/pulled-pork.jpg",
...
export const oatsWithBerriesDocumentDto: PostDocumentDto = {
  _id: new Types.ObjectId().toString(),
  publishDate: "2025-04-14T11:30:00.000Z",
  title: "Overnight Oats with Berries",
  imageUrl: "https://example.com/images/overnight-oats.jpg",
